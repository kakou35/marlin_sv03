...
#define STRING_CONFIG_H_AUTHOR "SONIC_GWADA SV03" // Who made the changes.
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 127.58
  #define DEFAULT_bedKi 25.12
  #define DEFAULT_bedKd 431.99
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.80, 79.80, 399.80, 932 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -27, -37.20, 0 }
